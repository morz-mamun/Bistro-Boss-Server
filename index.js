...
async function run() {
  try {
    ...
    app.patch("/menus/:id", async (req, res) => {
      ...
      const result = await menuCollection.patch(filter, updatedDoc);
      res.send(result);
    });
    ...
    app.post("/payment", async (req, res) => {
      ...
      mg.messages
        .create(process.env.PaymentInfo_Sending_Domain, {
          from: "Mailgun Sandbox <postmaster@process.env.PaymentInfo_Sending_Domain>",
          to: ["morzmamun@gmail.com"],
          subject: "Hello",
    ...
    app.get("/admin-stats", verifyToken, verifyAdmin, async (req, res) => {
      ...
      //this is not the best way to get one field value from any collection.
